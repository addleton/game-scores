...
console.log(user)
  ...
  if (loading) {
    ...
    return (
      <div className="hero min-h-screen min-w-screen bg-base-100">
        <div className="hero-content flex-col box-content bg-base-200 shadow-xl rounded-lg min-w-96">
          <h1 className="text-4xl font-bold">{game.name}</h1>
          <div className="hero-content flex-col lg:flex-row">
            <img
              src={game.img}
              className="max-w-2xl rounded-lg shadow-2xl mr-12 ml-12 flex-shrink-0"
            />
            <div className="divider lg:divider-horizontal" />
            <div className="container ml-12 mr-12 flex flex-col self-start flex-grow">
