...
import { RawgGame, User } from "./types/Types";
function App() {
    ...
    useEffect(() => {
        const unsubscribe = onAuthStateChanged(auth, async (user) => {
            if (user) {
                const loggedInUser = (await getSignedInUserInfo(
                    user.uid
                )) as User;
    ...
    return (
        <>
            ...
            <Routes>
                ...
                />
                <Route path="/games/:id" element={<GameScorePage />} />
                <Route
                    path="/games/add-game"
                    element={<NotScoredPage game={selectedGame} />}
                />
                <Route path="/games/:id/add-score" element={<AddScorePage />} />
